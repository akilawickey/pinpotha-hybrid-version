...
export class Ionic_2_Firebase {
  ...
  appPages: PageInterface[] = [
    { title: 'Add a memory', component: TabsPage, tabComponent: EnterDataPage, icon: 'create' },
    { title: 'Show memories', component: TabsPage, tabComponent: ShowDataPage, index: 1, icon: 'clipboard' }
